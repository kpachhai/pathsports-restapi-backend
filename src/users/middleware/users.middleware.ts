...
class UsersMiddleware {
    ...
    async validateSameDidBelongToSameUser(req: express.Request, res: express.Response, next: express.NextFunction) {
        const user = await userService.getUserByDid(req.body.did);
    ...
    validatePatchDid = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
        if (req.body.did) {
